...
def calc_bubble_score(sdata: Dict[str, Any], figure_path: str, bubble_key: str) -> None:
    ...
    helperfuncs.write_image_pdf(fig, f'{figure_path}/histogram_log10_thinness_score.pdf', scale=int(DPI/100))
    ...
    helperfuncs.write_image_pdf(fig, f'{figure_path}/violinplot_log10_cell_areas.pdf', scale=int(DPI/100))
