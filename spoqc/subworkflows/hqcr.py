...
def generate_hqcr_html(figure_path, df_plot, cat, ncat, catnames, qc_metrics):
    ...
    for level in qc_metrics:
        ...
        helperfuncs.write_image_pdf(fig, f"{figure_path}/{plotname}_{level}.pdf", scale=3)
    ...
    if ( annotation_file != "" ):
        ...
        for qc_metric in qc_metrics:
            if qc_metric in [counts, 'n_genes_by_counts', 'num_low_qc_transcript']:
                ...
                helperfuncs.write_image_pdf(fig, f"{figure_path}/split_violinplot_{qc_metric}.pdf", scale=3)
        ...
        helperfuncs.write_image_pdf(fig_bar, f"{figure_path}/barplot_total_artefact_scores.pdf", scale=3)
