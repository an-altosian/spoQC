...
def transcriptqc(sdata, figure_path, annotation_file, key_transcripts):
    ...
    helperfuncs.write_image_pdf(fig, f"{figure_path}/transcript_location_pie.pdf", scale=3)
    ...
    helperfuncs.write_image_pdf(fig, f"{figure_path}/transctipt_type_pie.pdf", scale=3)
...
def transcriptz(sdata: Any, figure_path: str, key_transcripts: str) -> None:
    ...
    helperfuncs.write_image_pdf(fig, f"{figure_path}/histogram_z_total.pdf", scale=3)
    timer.stop()
    ...
    helperfuncs.write_image_pdf(fig, f"{figure_path}/histogram_z_all.pdf", scale=3)
