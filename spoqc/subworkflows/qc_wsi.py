...
def measure_stripe_thickness_and_black_area(image_path: str, 
    ...
    helperfuncs.savefig_pdf(f'{output_path}/domain_thickness_score.pdf', bbox_inches='tight', dpi=300)
    plt.close()
...
def generate_input(sdata, figure_path, CONST):
    ...
    helperfuncs.savefig_pdf(f'{figure_path}/input_domain_thickness_analysis.pdf', bbox_inches='tight')
    plt.close()