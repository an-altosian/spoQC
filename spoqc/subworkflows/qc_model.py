...
def plot_pca_scatter(df, figure_path, nPCs, flip=False):
    ...
    helperfuncs.savefig_pdf(f'{figure_path}/scatterplot_PCs.pdf', bbox_inches='tight')
    plt.close()
    ...
    for i in range(0, nPCs):
        ...
        helperfuncs.savefig_pdf(f'{figure_path}/scatterplot_PC{i+1}.pdf', bbox_inches='tight')
        plt.close()
...
def plot_spatial_vs_exression_variance(sdata, figure_path, df, nPCs):
    ...
    helperfuncs.write_image_pdf(fig, f"{figure_path}/pca_evaluation_spatial_variance.pdf", scale=3)
    ...
    helperfuncs.write_image_pdf(fig, f"{figure_path}/pca_evaluation_moransi.pdf", scale=3)
