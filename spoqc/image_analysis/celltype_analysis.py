...
def start_image_celltype_analysis(
    ...
    for object in ['cell']:
        ...
        for qc_metric in qc_metrics:
            ...
            helperfuncs.write_image_pdf(fig, f"{figure_path}/split_violinplot_{qc_metric}_{object}.pdf", scale=3)
        ...
        if ( object == 'cell' ):
            ...
            helperfuncs.write_image_pdf(fig_bar, f"{figure_path}/barplot_celltypes_{modality}.pdf", scale=3)
            ...
            helperfuncs.write_image_pdf(fig_pct, f"{figure_path}/barplot_celltypes_pct_{modality}.pdf", scale=3)
